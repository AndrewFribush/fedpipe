...
parameter is interchangeable with includeallorigins
...
Limit to events with a specific PAGER alert level lower than or equal
to the maxalertlevel. The allowed values are:

**maxalertlevel=green**:
Limit to events with PAGER alert level "green".

**maxalertlevel=yellow**:
Limit to events with PAGER alert level "yellow" or lower.

**maxalertlevel=orange**:
Limit to events with PAGER alert level "orange" or lower.

**maxalertlevel=red**:
Limit to events with PAGER alert level "red" or lower.
...
Limit to events with a specific PAGER alert level greater than or equal
to the minalertlevel. The allowed values are:

**minalertlevel=green**:
Limit to events with PAGER alert level "green" or higher.

**minalertlevel=yellow**:
Limit to events with PAGER alert level "yellow" or higher.

**minalertlevel=orange**:
Limit to events with PAGER alert level "orange" or higher.
