...
- International (CSV) (excluding PR)
- Puerto Rico (CSV)

## Statistics

- Statistics of Income annual extracts of tax-exempt organization financial data: Get expanded financial data on Form 990, 990-EZ and 990-PF filings by active organizations in a given calendar year.
- SOI Tax Stats IRS Data Book: View IRS statistical and organizational information on a fiscal year basis
- Charitable & exempt organizations statistics: Find information on other Statistics of Income studies relating to the tax-exempt sector.
- Split Interest Trust Data collected from Forms 5227, Split-Interest Trust Information Returns for:
- 2017 (CSV)
- 2016 (CSV)
