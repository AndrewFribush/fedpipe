...
Source: https://raw.githubusercontent.com/cfpb/ccdb5-api/main/swagger-config.yaml
...
components:
  parameters:
    ...
    field:
      name: field
      in: query
      description: If the parameter "search_term" has a value, use "field" to specify which field is searched. If not specified, "all" will be searched.
      schema:
        type: string
        enum:
          - company
