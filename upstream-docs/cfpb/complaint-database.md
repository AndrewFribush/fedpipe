...
Browse other complaint reports
...
Download all complaint data or download a subset of the data, such as all complaints for a specific product, by filtering the full dataset and downloading your results.

- Filter the full data set before you download
- Download all complaint data (CSV ZIP)
- See database field reference
- See past database releases

### Using our API

Looking to download our data and have more control over it? Use our Open Data API.
...
View the full list of complaint form products, sub-products, issues, and sub-issues available from August 2023 to the present
...
How to respond to complaints about your company
