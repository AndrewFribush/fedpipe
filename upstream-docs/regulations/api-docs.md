...
Source: https://open.gsa.gov/api/regulationsgov/

---

Regulations.gov API | GSA Open Technology
...
X-Api-Key
API key from api.data.gov. For sample purposes, you can use DEMO_KEY as an API key.
...
Open API specification file for the Regulations.gov API
