...
Source: https://dev.socrata.com/docs/queries/having.html

---

The HAVING Clause | Socrata
...
The HAVING clause allows you to filter your results of an aggregation using boolean operators, just like the HAVING clause in SQL. For example, to aggregate our earthquakes and get only the sources with more than 500 quakes:
