# endpoint BillEndpoint

Source: https://raw.githubusercontent.com/LibraryOfCongress/api.congress.gov/main/Documentation/BillEndpoint.md
...
## A Note on Introduced Dates for Bills in the 82nd-92nd Congresses (1951-1972)

Introduced dates are not yet available for all legislation in the 82nd-92nd Congresses, but will become available as collections are updated. When using the `sort=introducedDate` parameter in API calls, bills with a `null` `introducedDate` value will be come last in their group.
