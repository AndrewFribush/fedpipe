# endpoint CommitteeMeetingEndpoint

Source: https://raw.githubusercontent.com/LibraryOfCongress/api.congress.gov/main/Documentation/CommitteeMeetingEndpoint.md
...
- `<isManuallyCurated>` (e.g., Y)
  - This element displays if manual curation was required. The value is always "Y" for yes. 
- `<committees>` 
